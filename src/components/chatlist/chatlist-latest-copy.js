...
function ChatList({ redirected, setRedirected, setShowLocked, showLocked, theme }) {
    ...
    useEffect(() => {
        if (isChats && user) {
            document.getElementById("chats-button").classList.add("chatlist-chat-button");
            document.getElementById("chats-button").classList.remove("chathead-color");
            document.getElementById("groups-button").classList.remove("chatlist-chat-button");
            document.getElementById("groups-button").classList.add("chathead-color");
        }
        else if (!isChats && user) {
            document.getElementById("chats-button").classList.remove("chatlist-chat-button");
            document.getElementById("groups-button").classList.add("chatlist-chat-button");
            document.getElementById("groups-button").classList.remove("chathead-color");
            document.getElementById("chats-button").classList.add("chathead-color");
        }
    }, [isChats])
                                ...
                                <div className="chatlist-whole">
                                    <div className="chatlist-primary" >
                                        ...
                                        <div className="chatlist-header">
                                            <>
                                                <p onClick={changeChats} id="chats-button" className={theme == "dark" ? "chathead chathead-color chathead-color-dark" : "chathead chathead-color"}>Chats</p>
                                                {mcount > 0 ? <p className='mCCount' > {mcount} </p> : null}
                                            </>
                                            <>
                                                <p onClick={changeGroups} id="groups-button" className={theme == "dark" ? "chathead chathead-color chathead-color-dark" : "chathead chathead-color"}>Groups</p>
                                                                    ...
                                                                    : (
                                                                        thoughts == 0 && pidd == auth.currentUser?.uid
                                                                            ? <>
                                                                                ...
                                                                                <Link to=""><button>Write</button></Link>
                                                                            </>
                                                                            : (
                                                                                ...
                                                                                <div className="post-buttons">
                                                                                    ...
                                                                                    <div className="comment-section">
                                                                                        <img
                                                                                            className="cmnt"
                                                                                            // onClick={() => {
                                                                                            //     handleCmntSectionPosts(pp.id, tu.uid);
                                                                                            // }}
                                                                                            src={
                                                                                                theme == "dark"
                                                                                                    ? cmntd
