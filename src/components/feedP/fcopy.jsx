        ...
        const unsubscribeThoughts = db
            ...
            .onSnapshot((friendsSnapshot) => {
                ...
                friendsSnapshot.forEach((friendDoc) => {
                    ...
                    if (friendData.status === 'approve') { // Check the status field
                                        ...
                                        thoughts == 0
                                            ...
                                            : (
                                                thoughts && thoughts.map((tp) => {
                                                    ...
                                                    return (
                                                        <div className="home-post" key={tp.id}>
                                                            ...
                                                            <p className="thought-content post-cont"> {tp.caption} </p>
                                                                            ...
                                                                            cm.pid === tp.id ? (
                                                                                cm.uid === auth.currentUser.uid ? (
                                                                                    <div className="commentHT">
                                                                                        ...
                                                                                        <p className="comment-cntnt">{cm.content}</p>
                                                                                    </div>
                                                                                ) : (
                                                                                    <div className="commentHT">
                                                                                        <div className="comment-head">
